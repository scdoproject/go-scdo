	...
	baseCommands := []cli.Command{
		{
			...
			Action: rpcAction("scdo", "getBalance"),
		},
		{
			Name:   "sendtx",
		...
		},
		{
			...
			Action: rpcAction("scdo", "getBlock"),
		},
		{
		...
		},
		{
			...
			Flags:  rpcFlags(hashFlag, heightFlag),
			Action: rpcAction("scdo", "getBlockTransactionCount"),
		},
		{
			Name:   "gettxinblock",
		...
		},
		{
			...
			Action: rpcAction("scdo", "getReceiptByTxHash"),
		},
		{
			Name:   "getpendingtxs",
	...
	p2pCommands := cli.Command{
		...
		Subcommands: []cli.Command{
			...
			},
			{
				...
				Usage:  "get scdo protocol version",
				Flags:  rpcFlags(),
			...
			},
			{
				...
				Usage:  "get number of trusted nodes",
				Flags:  rpcFlags(),
				Action: rpcAction("network", "getToTrustNodeCount"),
			},
			{
				Name:   "getblocklistcount",
				Usage:  "get number of blocklist nodes",
				Flags:  rpcFlags(),
