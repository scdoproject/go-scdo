...
ADD . /go/src/github.com/seelecredo/go-seelecredo

WORKDIR /go/src/github.com/seelecredo/go-seelecredo
...
COPY --from=builder /go/src/github.com/seelecredo/go-seelecredo/build /slc
